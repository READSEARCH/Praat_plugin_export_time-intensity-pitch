...
# Add a READSEARCH export sound data-submenu for preferences to the Object window's Preferences menu
# item.
Add menu command: "Objects", "Preferences", "-- READSEARCH export sound data --", "", 0, ""
Add menu command: "Objects", "Preferences", "READSEARCH export sound data", "-- READSEARCH export sound data --", 0, ""
Add menu command: "Objects", "Preferences", "Preferences...", "READSEARCH export sound data", 1, "settingsWindow.praat"
Add menu command: "Objects", "Preferences", "About...", "READSEARCH export sound data", 1, "about.praat"
...
if getString.result$ == ""
  @saveString: "pitchAndIntensityOutputPath", shellDirectory$ + "/WPP/"
endif
